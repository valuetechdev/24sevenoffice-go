...
type AddressBasic struct {
	...
	CountrySubdivision string `json:"countrySubdivision,omitzero"`

	// PostalArea The postal area for the address.
	PostalArea string `json:"postalArea,omitzero"`
...
type AggregationElement struct {
	...
	Balances []AmountElement `json:"balances,omitempty,omitzero"`
}
...
type AmountElement struct {
	...
	Change float32 `json:"change,omitempty,omitzero"`

	// Closing The closing balance of the account for the specified period.
	Closing float32 `json:"closing,omitempty,omitzero"`
	...
	Opening float32 `json:"opening,omitempty,omitzero"`
}
...
type BadRequestError struct {
	...
	Error struct {
		...
		Name BadRequestErrorErrorName `json:"name,omitempty,omitzero"`
		...
		Payload struct {
			...
			Errors []struct {
				...
				Type BadRequestErrorErrorPayloadErrorsType `json:"type,omitempty,omitzero"`
			} `json:"errors,omitempty,omitzero"`
		} `json:"payload,omitempty,omitzero"`
...
type BankAccountBalance struct {
	...
	Amount float32 `json:"amount,omitempty,omitzero"`

	// Currency The currency of the balance.
	Currency struct {
		// Code The currency code of the balance.
		Code string `json:"code"`
	} `json:"currency,omitempty,omitzero"`
...
type BankAccountResponse struct {
	...
	Balance BankAccountBalance `json:"balance,omitempty,omitzero"`
...
type CategoryBase struct {
	...
	ParentId float32 `json:"parentId,omitempty,omitzero"`
}
...
type Customer1 struct {
	...
	OrganizationNumber string `json:"organizationNumber,omitempty,omitzero"`

	// PostalArea The postal area for the address.
	PostalArea string `json:"postalArea,omitempty,omitzero"`
...
type CustomerPostRequest0 struct {
	...
	// Name A human-readable name or label for a customer, making it easily identifiable to users.
	Name   string `json:"name"`
	Person string `json:"person,omitzero"`
}
...
type CustomerProperties struct {
	...
	// IsCompany A flag variable indicating whether the customer is a company (true) or a person (false).
	IsCompany bool `json:"isCompany,omitempty,omitzero"`
...
type Fiscal struct {
	...
	StartingDate openapi_types.Date `json:"startingDate,omitempty,omitzero"`
}
...
type IdentifierModel struct {
	...
	Id     openapi_types.UUID      `json:"id,omitempty,omitzero"`
	Status CommunicationStatusType `json:"status,omitempty,omitzero"`
...
type Invoice struct {
	...
	DueDate openapi_types.Date `json:"dueDate,omitempty,omitzero"`
...
type LicenseModel struct {
	...
	IdentityId openapi_types.UUID `json:"identityId,omitzero"`

	// Name The name of the organization.
	Name string `json:"name,omitzero"`

	// OrganizationId The identifier for the organization.
	OrganizationId int64 `json:"organizationId,omitzero"`

	// PersonId The identifier for the connected person.
	PersonId int32 `json:"personId,omitzero"`
}
...
type OrganizationModel1 struct {
	...
	Address AddressModel `json:"address,omitempty,omitzero"`

	// Contact Contact information for the organization.
	Contact ClientContactModel `json:"contact,omitempty,omitzero"`
	...
	InvoiceEmail string `json:"invoiceEmail,omitzero"`

	// Name The name of the organization.
	Name string `json:"name,omitzero"`

	// Settings Settings for the organization.
	Settings OrganizationSettingsModel `json:"settings,omitempty,omitzero"`

	// Status The state of the organization.
	Status ClientStateType `json:"status,omitempty,omitzero"`
}
...
type ProductResponse struct {
	// Category Information about the category to which the product belongs.
	Category CategoryResponse1 `json:"category,omitempty,omitzero"`
...
type ProfileModel struct {
	...
	Culture string `json:"culture,omitzero"`
...
type SalesOrder struct {
	...
	Customer Customer1 `json:"customer,omitempty,omitzero"`
	...
	Invoice Invoice1 `json:"invoice,omitempty,omitzero"`

	// Memo A memo or comments for the sales order.
	Memo string `json:"memo,omitempty,omitzero"`
...
type TfsoApiOrganizationUnitOfWorkModelsPersonModel struct {
	...
	HasLicense bool `json:"hasLicense,omitempty,omitzero"`
	...
	LastName   string                            `json:"lastName,omitzero"`
	PersonType TfsoApiOrganizationModelsUserType `json:"personType,omitempty,omitzero"`
}
...
type Transaction struct {
	...
	// Invoice Details of an invoice used within 24SevenOffice.
	Invoice Invoice `json:"invoice,omitempty,omitzero"`

	// ModifiedAt A timestamp for when one of the properties of a record was last modified, in ISO 8601 format.
	ModifiedAt time.Time `json:"modifiedAt,omitempty,omitzero"`

	// Tax Details of a tax used within 24SevenOffice.
	Tax Tax `json:"tax,omitempty,omitzero"`
	...
	Transaction Voucher `json:"transaction,omitempty,omitzero"`

	// TransactionType Details of a transaction type used within the 24SevenOffice accounting module.
	TransactionType TransactionType `json:"transactionType,omitempty,omitzero"`
}
...
type ValidationError struct {
	...
	Error struct {
		// Name The name for the error.
		Name ValidationErrorErrorName `json:"name,omitempty,omitzero"`
		...
		Payload struct {
			...
			ValidationErrors []struct {
				...
				Keyword string `json:"keyword,omitempty,omitzero"`

				// Path A path for the invalid field.
				Path string `json:"path,omitempty,omitzero"`
			} `json:"validationErrors,omitempty,omitzero"`
		} `json:"payload,omitempty,omitzero"`
	} `json:"error,omitempty,omitzero"`
...
type GetAccountbalancesParams struct {
	...
	Periods Periods `form:"periods,omitempty" json:"periods,omitempty,omitzero"`

	// Type Specifies the type of data to be retrieved.
	Type Type `form:"type,omitempty" json:"type,omitempty,omitzero"`

	// KeepIncoming Indicates whether to include incoming amounts in the response. Default is false.
	KeepIncoming KeepIncoming `form:"keepIncoming,omitempty" json:"keepIncoming,omitempty,omitzero"`
}
...
type GetBankaccountsParams struct {
	...
	Before openapi_types.Date `form:"before,omitempty" json:"before,omitempty,omitzero"`
}
...
type GetBanktransactionsParams struct {
	...
	BankAccountId openapi_types.UUID `form:"bankAccountId,omitempty" json:"bankAccountId,omitempty,omitzero"`
...
type GetCustomersParams struct {
	...
	OrganizationNumber string `form:"organizationNumber,omitempty" json:"organizationNumber,omitempty,omitzero"`

	// IsCompany A flag variable to filter customers by company or person.
	IsCompany bool `form:"isCompany,omitempty" json:"isCompany,omitempty,omitzero"`

	// IsSupplier A flag variable to filter customers by being a supplier or not.
	IsSupplier bool `form:"isSupplier,omitempty" json:"isSupplier,omitempty,omitzero"`
...
type GetMeIdentifiersParams struct {
	...
	Type string `form:"type,omitempty" json:"type,omitempty,omitzero"`

	// Status Status of the identifier as per communication status type.
	Status CommunicationStatusType `form:"status,omitempty" json:"status,omitempty,omitzero"`
}
...
type GetLicensesParams struct {
	...
	OrganizationId int64 `form:"organizationId,omitempty" json:"organizationId,omitempty,omitzero"`

	// PersonId Identifier for the connected person.
	PersonId int32 `form:"personId,omitempty" json:"personId,omitempty,omitzero"`
}
...
type GetOrganizationPeopleParams struct {
	...
	PersonType TfsoApiOrganizationModelsUserType `form:"personType,omitempty" json:"personType,omitempty,omitzero"`
}
...
type GetProductsParams struct {
	...
	ProductSearch string `form:"productSearch,omitempty" json:"productSearch,omitempty,omitzero"`

	// ProductNumber Searches for product number.
	ProductNumber string `form:"productNumber,omitempty" json:"productNumber,omitempty,omitzero"`
}
...
type GetSalesordersParams struct {
	...
	ContinuationToken string `form:"continuationToken,omitempty" json:"continuationToken,omitempty,omitzero"`
	...
	DateFrom openapi_types.Date `form:"dateFrom,omitempty" json:"dateFrom,omitempty,omitzero"`
	...
	CreatedFrom time.Time `form:"createdFrom,omitempty" json:"createdFrom,omitempty,omitzero"`

	// CreatedTo An end date-time to filter sales orders by creation time.
	CreatedTo time.Time `form:"createdTo,omitempty" json:"createdTo,omitempty,omitzero"`

	// ModifiedFrom A start date-time to filter sales orders by modification time.
	ModifiedFrom time.Time `form:"modifiedFrom,omitempty" json:"modifiedFrom,omitempty,omitzero"`
...
type PostSalesordersJSONBody struct {
	...
	Customer  struct {
		...
		// PostalCode The postal code for the address.
		PostalCode string `json:"postalCode,omitempty,omitzero"`
	} `json:"customer,omitempty,omitzero"`
...
type GetTransactionlinesParams struct {
	...
	CurrencyCode string `form:"currencyCode,omitempty" json:"currencyCode,omitempty,omitzero"`
...
type GetSalesordersResponse struct {
	...
	HALJSON200   *struct {
		UnderscoreEmbedded struct {
			Salesorders []SalesOrder `json:"salesorders,omitempty,omitzero"`
		} `json:"_embedded,omitempty,omitzero"`
	}
	JSON200 *[]SalesOrder
}
...
type GetSalesordersIdResponse struct {
	...
	HALJSON200   *struct {
		UnderscoreEmbedded struct {
			Lines []Line `json:"lines,omitempty,omitzero"`
		} `json:"_embedded,omitempty,omitzero"`
