...
type BankAccountBase struct {
	...
	Type *BankAccountBaseType `json:"type,omitempty"`
}
...
type BankAccountResponse struct {
	...
	// * `bban`: Basic Bank Account Number is a country-specific bank account number format.
	// * `iban`: International Bank Account Number format.
	Type *BankAccountResponseType `json:"type,omitempty"`
}
...
type BankTransactionBase struct {
	...
	} `json:"bankTransactionCode,omitempty"`
	...
	FromBankAccount *struct {
		...
		Type *BankTransactionBaseFromBankAccountType `json:"type"`
	} `json:"fromBankAccount,omitempty"`
	...
	} `json:"paymentReference,omitempty"`
	...
	ToBankAccount *struct {
		...
		Type *BankTransactionBaseToBankAccountType `json:"type"`
	} `json:"toBankAccount,omitempty"`
	...
	Type *BankTransactionBaseType `json:"type,omitempty"`
}
...
type BankTransactionResponse struct {
	...
	FromBankAccount *struct {
		...
		// Type Type of the originating bank account for outbound transactions.
		Type *BankTransactionResponseFromBankAccountType `json:"type"`
	} `json:"fromBankAccount,omitempty"`
	...
	ToBankAccount *struct {
		...
		// Type Type of the receiving bank account for inbound transactions.
		Type *BankTransactionResponseToBankAccountType `json:"type"`
	} `json:"toBankAccount,omitempty"`

	// Type Direction of the payment. "Inbound" stands for an incoming payment. E.g. a payment of an invoice by a customer. "Outbound" is a payment originating from this bank account. E.g a debet card transaction, when paid for goods and services.
	Type *BankTransactionResponseType `json:"type,omitempty"`
}
...
type LineWithoutId struct {
	...
	// Type A specification for the type of the line item, whether this is a product or a text entry.
	Type *LineWithoutIdType `json:"type,omitempty"`
}
...
type ProductRequestPatch struct {
	...
	// Status Specifies whether the product's status is active or inactive (expired).
	Status *ProductRequestPatchStatus `json:"status,omitempty"`
	...
	// Type Specifies whether the product is defined as a regular or structure product.
	Type  *ProductRequestPatchType `json:"type,omitempty"`
	Units *struct {
...
type ProductRequestPost struct {
	...
	// Status Specifies whether the product's status is active or inactive (expired).
	Status *ProductRequestPostStatus `json:"status,omitempty"`
	...
	// Type Specifies whether the product is defined as a regular or structure product.
	Type  *ProductRequestPostType `json:"type,omitempty"`
	Units *struct {
		// Id The ID of the units of measurement. Product units can be retrieved from the separate `/productunits` endpoint.
		Id *float32 `json:"id"`
	} `json:"units,omitempty"`
...
type ProductResponse struct {
	...
	// Status Specifies whether the product's status is active or inactive (expired).
	Status *ProductResponseStatus `json:"status,omitempty"`
	...
	// Type Specifies whether the product is defined as a regular or structure product.
	Type  *ProductResponseType `json:"type,omitempty"`
	Units *struct {
		// Id The ID of the units of measurement. Product units can be retrieved from the separate `/productunits` endpoint.
		Id *float32 `json:"id"`
...
type SalesOrderWithoutCustomer struct {
	...
	// Status Current status of the sales order.
	Status *SalesOrderWithoutCustomerStatus `json:"status,omitempty"`
}
...
type Transaction struct {
	...
	Currency *Currency1 `json:"currency,omitempty"`
...
type GetSalesordersParams struct {
	...
	Status *GetSalesordersParamsStatus `form:"status,omitempty" json:"status,omitempty"`
...
type GetTransactionlinesParams struct {
	...
	TransactionTypeId *float32 `form:"transactionTypeId,omitempty" json:"transactionTypeId,omitempty"`

	// CustomerId ID of the customer involved in the transaction.
	CustomerId *float32 `form:"customerId,omitempty" json:"customerId,omitempty"`
	...
	AccountNumber *float32 `form:"accountNumber,omitempty" json:"accountNumber,omitempty"`
...
type GetSalesordersIdResponse struct {
	...
	HALJSON200   *struct {
		...
		// Status Current status of the sales order.
		Status *GetSalesordersId200Status `json:"status,omitempty"`
	}
	JSON200 *SalesOrder
}
